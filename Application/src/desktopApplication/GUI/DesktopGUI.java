...
public class DesktopGUI extends Application {
	...
	public void start(Stage appStage) throws Exception{
		...
		avaBedsField.setFont(Font.font("Helvetica",14));
		...
		totBedsField.setFont(Font.font("Helvetica",14));
	    ...
	    row2.setPercentHeight(16);
	    RowConstraints row3 = new RowConstraints();
	    row3.setPercentHeight(18);
	    RowConstraints row4 = new RowConstraints();
	    row4.setPercentHeight(18);
	    RowConstraints row5 = new RowConstraints();
	    row5.setPercentHeight(16);
	    RowConstraints row6 = new RowConstraints();
	    row6.setPercentHeight(16);
	    root.getRowConstraints().addAll(row1,row2,row3,row4,row5,row6);
