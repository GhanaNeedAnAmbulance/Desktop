...
public class NumberSpinner extends HBox {
    ...
    public NumberSpinner(BigDecimal value, BigDecimal stepWidth) {
        this(value, stepWidth, NumberFormat.getInstance(), Font.font("Helvetica",10),50);
    }

    public NumberSpinner(BigDecimal value, BigDecimal stepWidth, NumberFormat nf, Font font, int fieldWidth) {
        super();
        ...
        numberField.setMaxWidth(fieldWidth);
